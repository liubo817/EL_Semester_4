...
REM
REM Generated by Vivado on Fri Apr 03 13:08:56 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_pwm_duty_vhdl.prj"
call xvhdl  --incr --relax -prj tb_pwm_duty_vhdl.prj -log xvhdl.log
