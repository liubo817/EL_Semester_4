...
HD_PWD='C:/Users/liubo/Documents/SDU/Semester 4/DDSP/PWM_duty/PWM_duty.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_duty.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm_duty.tcl -notrace
