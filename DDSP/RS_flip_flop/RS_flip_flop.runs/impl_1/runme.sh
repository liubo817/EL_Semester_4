...
HD_PWD='C:/Users/liubo/Documents/SDU/Semester 4/DDSP/RS_flip_flop/RS_flip_flop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RS_flip_flop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RS_flip_flop.tcl -notrace
