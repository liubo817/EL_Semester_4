...
HD_PWD='C:/Users/liubo/Documents/SDU/Semester 4/DDSP/RS_flip_flop/RS_flip_flop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RS_flip_flop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RS_flip_flop.tcl
