...
REM
REM Generated by Vivado on Wed Feb 11 10:46:17 +0100 2026
...
echo "xvhdl --incr --relax -prj testbench_full_adder_vhdl.prj"
call xvhdl  --incr --relax -prj testbench_full_adder_vhdl.prj -log xvhdl.log
