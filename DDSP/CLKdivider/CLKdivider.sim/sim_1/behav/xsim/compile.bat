...
REM
REM Generated by Vivado on Tue Mar 24 13:24:30 +0100 2026
...
echo "xvhdl --incr --relax -prj testnDiv_vhdl.prj"
call xvhdl  --incr --relax -prj testnDiv_vhdl.prj -log xvhdl.log
