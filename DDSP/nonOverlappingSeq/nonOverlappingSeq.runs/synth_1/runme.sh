...
HD_PWD='C:/Users/liubo/Documents/GitHub projects/DDSP/Assignment2/nonOverlappingSeq/nonOverlappingSeq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nonOverlappingSeq.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nonOverlappingSeq.tcl
