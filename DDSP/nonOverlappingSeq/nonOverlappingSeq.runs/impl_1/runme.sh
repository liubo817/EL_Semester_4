...
HD_PWD='C:/Users/liubo/Documents/GitHub projects/DDSP/Assignment2/nonOverlappingSeq/nonOverlappingSeq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nonOverlappingSeq.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nonOverlappingSeq.tcl -notrace
