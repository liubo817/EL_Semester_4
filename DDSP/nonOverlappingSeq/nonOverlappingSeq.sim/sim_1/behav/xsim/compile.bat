...
REM
REM Generated by Vivado on Tue Mar 17 14:34:09 +0100 2026
...
echo "xvhdl --incr --relax -prj tb_nonOverlappingSeq_vhdl.prj"
call xvhdl  --incr --relax -prj tb_nonOverlappingSeq_vhdl.prj -log xvhdl.log
