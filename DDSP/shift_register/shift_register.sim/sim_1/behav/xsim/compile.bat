...
REM
REM Generated by Vivado on Wed Mar 04 10:47:22 +0100 2026
...
echo "xvhdl --incr --relax -prj testbench_shift_vhdl.prj"
call xvhdl  --incr --relax -prj testbench_shift_vhdl.prj -log xvhdl.log
