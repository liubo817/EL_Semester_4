...
HD_PWD='C:/Users/liubo/Documents/SDU/Semester 4/DDSP/Structures_basic/Structures_basic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log half_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source half_adder.tcl -notrace
