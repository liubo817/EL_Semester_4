...
HD_PWD='C:/Users/liubo/Documents/SDU/Semester 4/DDSP/Structures_basic/Structures_basic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log half_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source half_adder.tcl
