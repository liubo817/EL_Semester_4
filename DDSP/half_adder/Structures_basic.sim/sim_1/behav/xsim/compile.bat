...
REM
REM Generated by Vivado on Tue Feb 17 15:15:45 +0100 2026
...
echo "xvhdl --incr --relax -prj testbench_half_adder_vhdl.prj"
call xvhdl  --incr --relax -prj testbench_half_adder_vhdl.prj -log xvhdl.log
