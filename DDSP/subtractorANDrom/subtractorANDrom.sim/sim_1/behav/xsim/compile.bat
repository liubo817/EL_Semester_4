...
REM
REM Generated by Vivado on Tue Mar 24 15:41:12 +0100 2026
...
echo "xvhdl --incr --relax -prj testROM_vhdl.prj"
call xvhdl  --incr --relax -prj testROM_vhdl.prj -log xvhdl.log
