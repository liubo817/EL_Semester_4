...
REM
REM Generated by Vivado on Sun Mar 15 18:50:47 +0100 2026
...
echo "xvhdl --incr --relax -prj tb_pipoRegister_vhdl.prj"
call xvhdl  --incr --relax -prj tb_pipoRegister_vhdl.prj -log xvhdl.log
