...
HD_PWD='C:/Users/liubo/Documents/SDU/Semester 4/DDSP/PIPO_register/PIPO_register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pipoRegister.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pipoRegister.tcl
