...
HD_PWD='C:/Users/liubo/Documents/SDU/Semester 4/DDSP/PIPO_register/PIPO_register.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pipoRegister.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pipoRegister.tcl -notrace
