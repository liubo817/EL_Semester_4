...
HD_PWD='C:/Users/liubo/Documents/SDU/Semester 4/DDSP/assignment_1/assignment_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log assignment_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source assignment_1.tcl
