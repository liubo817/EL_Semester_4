...
HD_PWD='C:/Users/liubo/Documents/SDU/Semester 4/DDSP/assignment_1/assignment_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log assignment_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source assignment_1.tcl -notrace
