...
HD_PWD='C:/Users/liubo/Documents/SDU/Semester 4/DDSP/MUX/MUX.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MUX.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MUX.tcl -notrace
