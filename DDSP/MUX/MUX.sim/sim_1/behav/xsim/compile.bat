...
REM
REM Generated by Vivado on Tue Feb 17 14:16:44 +0100 2026
...
echo "xvhdl --incr --relax -prj testbench_mux_vhdl.prj"
call xvhdl  --incr --relax -prj testbench_mux_vhdl.prj -log xvhdl.log
