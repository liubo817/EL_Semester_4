...
REM
REM Generated by Vivado on Tue Feb 24 15:40:06 +0100 2026
...
echo "xvlog --incr --relax -prj test4_vlog.prj"
call xvlog  --incr --relax -prj test4_vlog.prj -log xvlog.log
call type xvlog.log > compile.log
REM compile VHDL design sources
echo "xvhdl --incr --relax -prj test4_vhdl.prj"
call xvhdl  --incr --relax -prj test4_vhdl.prj -log xvhdl.log
